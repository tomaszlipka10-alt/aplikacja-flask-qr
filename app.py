...
if db_url:
    ...
    # On Render the app directory may be read-only; keep SQLite in a writable location.
...
# Ensure SQLite directory exists (Render uses /tmp).
if app.config["SQLALCHEMY_DATABASE_URI"].startswith("sqlite:////"):
    try:
        db_file = app.config["SQLALCHEMY_DATABASE_URI"].replace("sqlite:////", "/", 1)
